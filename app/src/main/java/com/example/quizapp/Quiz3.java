...
public class Quiz3 extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int nb_question = Questions3.question.length;
    int num_question = 0;
    String choix_rep = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rep1.setOnClickListener(Quiz3.this);
        rep2.setOnClickListener(Quiz3.this);
        rep3.setOnClickListener(Quiz3.this);
        rep4.setOnClickListener(Quiz3.this);
    ...
    public void onClick(View view) {
        ...
        {
            if(choix_rep.equals(Questions3.correctAnswers[num_question])) {
                score++;
            }
            num_question++;
            genererQuestion();
    ...
    void genererQuestion() {
        ...
        question.setText(Questions3.question[num_question]);
        rep1.setText(Questions3.choix[num_question][0]);
        rep2.setText(Questions3.choix[num_question][1]);
        rep3.setText(Questions3.choix[num_question][2]);
        rep4.setText(Questions3.choix[num_question][3]);
    }

    void finQuiz() {
        Intent intent = new Intent(Quiz3.this,Resultat.class);
