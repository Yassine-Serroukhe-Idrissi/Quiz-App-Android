...
public class Quiz2 extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int nb_question = Questions2.question.length;
    int num_question = 0;
    String choix_rep = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rep1.setOnClickListener(Quiz2.this);
        rep2.setOnClickListener(Quiz2.this);
        rep3.setOnClickListener(Quiz2.this);
        rep4.setOnClickListener(Quiz2.this);
    ...
    public void onClick(View view) {
        ...
        {
            if(choix_rep.equals(Questions2.correctAnswers[num_question])) {
                score++;
            }
            num_question++;
            genererQuestion();
    ...
    void genererQuestion() {
        ...
        question.setText(Questions2.question[num_question]);
        rep1.setText(Questions2.choix[num_question][0]);
        rep2.setText(Questions2.choix[num_question][1]);
        rep3.setText(Questions2.choix[num_question][2]);
        rep4.setText(Questions2.choix[num_question][3]);
    }

    void finQuiz() {
        Intent intent = new Intent(Quiz2.this,Resultat.class);
